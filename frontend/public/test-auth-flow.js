...
async function testRegistration() {
  ...
  try {
    ...
    if (!authContext) {
      throw new Error('Auth context not available. Make sure you are on the /debug page and the component has loaded.')
    }
...
// Helper function to check if auth context is ready
function checkAuthContextReady() {
  if (window.authContext) {
    console.log('✅ Auth context is ready for testing')
    return true
  } else {
    console.log('❌ Auth context not available')
    console.log('💡 Make sure you are on the /debug page and the component has loaded')
    return false
  }
}
...
window.checkAuthContextReady = checkAuthContextReady
...
if (window.authContext) {
  console.log('✅ Auth context detected and ready for testing')
} else {
  console.log('⚠️ Auth context not yet available. Make sure you are on the /debug page.')
  console.log('💡 The auth context will be available once the AuthDebug component loads.')
}
